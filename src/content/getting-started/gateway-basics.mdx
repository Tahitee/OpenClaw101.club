---
title: Gateway 基础
description: 了解 OpenClaw Gateway 的核心概念、启动管理和部署方式
---
...
1. **[配置文件详解](/docs/config/config-guide)** — 深入了解 OpenClaw 的配置体系
2. **[打造你的 AI 人设](/docs/config/persona)** — 赋予你的 AI 助手独特的人格
3. **[渠道配置](/docs/channels/overview)** — 连接你常用的通讯平台
